...
<?php 
   ...
   $fetchResult = fetchEventList($product_Id,$date,$time);
   ...
   if(count($fetchResult)==0){
       echo '
          ...
          <div class="alert alert-danger" style="text-align:center;">
            ...
            <h2><strong> No Event for Today !</strong></h2>
      ...
      echo '<!DOCTYPE html>
          ...
          <div style="padding-top: 80px;" class="container">
              ...
              <div class="container"  style="background-color: #eeeeee ; border-radius: 15px; text-align: center;">
                    <h1 ><i style="color: red; " class="fa fa-bell-o fa-2x"></i>
                    On Today</h1>
...
for ($i=0; $i < count($fetchResult); $i++) { 
        ...
        echo'<div style="padding-top: 6px; " class="container">
          ...
          <button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="'."#view".$fetchResult[$i]["eventId"].'  "
              style="background-color: #ff4444; height: 8%; border-radius: 15px; border:1;">
              ...
              <table class="table">
                  <tr >
                      ...
                      <td scope="row" colspan="1" style="text-align: center;width:20%;">
                         ...
                         <h5> at '.$fetchResult[$i]["eventTime"].'</h5>
                       </td>
