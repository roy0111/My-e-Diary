...
<?php 
   ...
   $fetchResult = fetchPassEventList($product_Id,$date);
   ...
   if(count($fetchResult)==0){
       echo '
          ...
          <div class="alert alert-success" style="text-align:center;">
            ...
            <h1 class="fa fa-smile-o fa-3x"></h1>
            <h2><strong> No Past Event</strong></h2>
      ...
      echo '<!DOCTYPE html>
          ...
          <div style="padding-top: 80px;" class="container">
              ...
              <div class="container"  style="background-color: #eeeeee ; border-radius: 15px;  text-align: right;">
                    <h1 ><i style="color: #FF8800; " class="fa fa-check-square-o fa-2x "></i>
                      Events Performed
                    </h1>
...
for ($i=0; $i < count($fetchResult); $i++) { 
        ...
        echo'<div style="padding-top: 6px; " class="container">
          ...
          <button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="'."#view".$fetchResult[$i]["eventId"].'  "
              style="background-color: #0099CC ; height: 8%; border-radius: 15px; border:1;">
              ...
              <table class="table">
                  <tr >
                      ...
                      <td scope="row" colspan="1" style="text-align: center;width:20%;">
                         ...
                         <h5> On '.$fetchResult[$i]["eventPostDate"].'</h5>
                       </td>
        ...
        <div class="modal fade" id="'."view".$fetchResult[$i]["eventId"].'" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header" style="background-color: #ff7043 ;">
