...
<?php 
   ...
   $fetchResult = fetchUpcomingEventList($product_Id,$date);
   ...
   if(count($fetchResult)==0){
       echo '
          ...
          <div class="alert alert-success" style="text-align:center;">
            ...
            <h1 class="fa fa-exclamation-circle fa-3x"></h1>
            <h2><strong> No Upcoming Event !!!</strong></h2>
          </div>
      ...
      echo '<!DOCTYPE html>
          ...
          <div style="padding-top: 80px;" class="container">
              ...
              <div class="container"  style="background-color: #eeeeee ; border-radius: 15px;  text-align: center;">
                    <h1 ><i style="color: #00C851; " class="fa fa-bullhorn fa-2x "></i>
                      Upcoming Events
                    </h1>
...
for ($i=0; $i < count($fetchResult); $i++) { 
        ...
        echo'<div style="padding-top: 6px; " class="container">
          ...
          <button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="'."#view".$fetchResult[$i]["eventId"].'  "
              style="background-color: #00C851; height: 8%; border-radius: 15px; border:1;">
